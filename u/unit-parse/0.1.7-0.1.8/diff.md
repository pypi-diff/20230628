# Comparing `tmp/unit_parse-0.1.7.tar.gz` & `tmp/unit_parse-0.1.8.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "unit_parse-0.1.7.tar", last modified: Sat Oct 22 23:14:17 2022, max compression
+gzip compressed data, was "unit_parse-0.1.8.tar", last modified: Wed Jun 28 12:38:32 2023, max compression
```

## Comparing `unit_parse-0.1.7.tar` & `unit_parse-0.1.8.tar`

### file list

```diff
@@ -1,31 +1,42 @@
-drwxrwxrwx   0        0        0        0 2022-10-22 23:14:17.529126 unit_parse-0.1.7/
--rw-rw-rw-   0        0        0     1564 2022-03-26 22:11:05.000000 unit_parse-0.1.7/LICENSE.txt
--rw-rw-rw-   0        0        0      163 2022-03-26 22:11:05.000000 unit_parse-0.1.7/MANIFEST.in
--rw-rw-rw-   0        0        0    15781 2022-10-22 23:14:17.530131 unit_parse-0.1.7/PKG-INFO
--rw-rw-rw-   0        0        0    15239 2022-08-25 22:04:02.000000 unit_parse-0.1.7/README.md
--rw-rw-rw-   0        0        0      909 2022-03-26 22:11:05.000000 unit_parse-0.1.7/pyproject.toml
--rw-rw-rw-   0        0        0      882 2022-10-22 23:14:17.532125 unit_parse-0.1.7/setup.cfg
--rw-rw-rw-   0        0        0       75 2022-03-26 22:11:05.000000 unit_parse-0.1.7/setup.py
-drwxrwxrwx   0        0        0        0 2022-10-22 23:14:17.457504 unit_parse-0.1.7/src/
-drwxrwxrwx   0        0        0        0 2022-10-22 23:14:17.506117 unit_parse-0.1.7/src/unit_parse/
--rw-rw-rw-   0        0        0      298 2022-03-26 22:11:05.000000 unit_parse-0.1.7/src/unit_parse/__init__.py
--rw-rw-rw-   0        0        0     6061 2022-03-26 22:11:05.000000 unit_parse-0.1.7/src/unit_parse/classification.py
--rw-rw-rw-   0        0        0     4615 2022-08-25 23:02:31.000000 unit_parse-0.1.7/src/unit_parse/config.py
--rw-rw-rw-   0        0        0    13298 2022-03-26 22:11:05.000000 unit_parse-0.1.7/src/unit_parse/core.py
--rw-rw-rw-   0        0        0     2849 2022-03-26 22:11:05.000000 unit_parse-0.1.7/src/unit_parse/logger.py
--rw-rw-rw-   0        0        0     1604 2022-08-25 23:02:31.000000 unit_parse-0.1.7/src/unit_parse/main.py
--rw-rw-rw-   0        0        0     4295 2022-03-26 22:11:05.000000 unit_parse-0.1.7/src/unit_parse/pre_processing_multiple.py
--rw-rw-rw-   0        0        0     6943 2022-10-22 23:03:22.000000 unit_parse-0.1.7/src/unit_parse/pre_processing_substitution.py
--rw-rw-rw-   0        0        0     7314 2022-03-26 22:11:05.000000 unit_parse-0.1.7/src/unit_parse/reduce_quantities.py
-drwxrwxrwx   0        0        0        0 2022-10-22 23:14:17.525118 unit_parse-0.1.7/src/unit_parse/support_files/
--rw-rw-rw-   0        0        0     4497 2022-03-26 22:11:05.000000 unit_parse-0.1.7/src/unit_parse/support_files/constants_en.txt
--rw-rw-rw-   0        0        0    24486 2022-03-26 22:11:05.000000 unit_parse-0.1.7/src/unit_parse/support_files/default_en.txt
--rw-rw-rw-   0        0        0  4226694 2022-03-26 22:11:05.000000 unit_parse-0.1.7/src/unit_parse/support_files/dictionary.txt
--rw-rw-rw-   0        0        0     5227 2022-08-25 23:02:31.000000 unit_parse-0.1.7/src/unit_parse/utils.py
-drwxrwxrwx   0        0        0        0 2022-10-22 23:14:17.523125 unit_parse-0.1.7/src/unit_parse.egg-info/
--rw-rw-rw-   0        0        0    15781 2022-10-22 23:14:17.000000 unit_parse-0.1.7/src/unit_parse.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      731 2022-10-22 23:14:17.000000 unit_parse-0.1.7/src/unit_parse.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2022-10-22 23:14:17.000000 unit_parse-0.1.7/src/unit_parse.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0        2 2022-03-27 17:19:56.000000 unit_parse-0.1.7/src/unit_parse.egg-info/not-zip-safe
--rw-rw-rw-   0        0        0       74 2022-10-22 23:14:17.000000 unit_parse-0.1.7/src/unit_parse.egg-info/requires.txt
--rw-rw-rw-   0        0        0       11 2022-10-22 23:14:17.000000 unit_parse-0.1.7/src/unit_parse.egg-info/top_level.txt
...
### Comparing `unit_parse-0.1.7/LICENSE.txt` & `unit_parse-0.1.8/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `unit_parse-0.1.7/PKG-INFO` & `unit_parse-0.1.8/PKG-INFO`
...
### Comparing `unit_parse-0.1.7/README.md` & `unit_parse-0.1.8/README.md`

 * *Files identical despite different names*

### Comparing `unit_parse-0.1.7/pyproject.toml` & `unit_parse-0.1.8/pyproject.toml`

 * *Files identical despite different names*

### Comparing `unit_parse-0.1.7/setup.cfg` & `unit_parse-0.1.8/setup.cfg`
...
@@ -35,15 +35,15 @@
 ...
 00000230: 332e 390d 0a70 6163 6b61 6765 5f64 6972  3.9..package_dir
 00000240: 203d 200d 0a09 3d73 7263 0d0a 7a69 705f   = ...=src..zip_
 00000250: 7361 6665 203d 206e 6f0d 0a69 6e63 6c75  safe = no..inclu
 00000260: 6465 5f70 6163 6b61 6765 5f64 6174 6120  de_package_data 
 00000270: 3d20 7472 7565 0d0a 696e 7374 616c 6c5f  = true..install_
 00000280: 7265 7175 6972 6573 203d 200d 0a09 7069  requires = ...pi
-00000290: 6e74 3e3d 302e 3138 0d0a 0d0a 5b6f 7074  nt>=0.18....[opt
+00000290: 6e74 3d3d 302e 3139 0d0a 0d0a 5b6f 7074  nt==0.19....[opt
 000002a0: 696f 6e73 2e65 7874 7261 735f 7265 7175  ions.extras_requ
 000002b0: 6972 655d 0d0a 7465 7374 696e 6720 3d20  ire]..testing = 
 000002c0: 0d0a 0970 7974 6573 743e 3d36 2e30 0d0a  ...pytest>=6.0..
 000002d0: 0970 7974 6573 742d 636f 763e 3d32 2e30  .pytest-cov>=2.0
 000002e0: 0d0a 096d 7970 793e 3d30 2e39 3130 0d0a  ...mypy>=0.910..
 000002f0: 0966 6c61 6b65 383e 3d33 2e39 0d0a 0d0a  .flake8>=3.9....
 00000300: 5b66 6c61 6b65 385d 0d0a 6d61 782d 6c69  [flake8]..max-li
```

### Comparing `unit_parse-0.1.7/src/unit_parse/classification.py` & `unit_parse-0.1.8/src/unit_parse/classification.py`

 * *Files identical despite different names*

### Comparing `unit_parse-0.1.7/src/unit_parse/config.py` & `unit_parse-0.1.8/src/unit_parse/config.py`

 * *Files identical despite different names*

### Comparing `unit_parse-0.1.7/src/unit_parse/core.py` & `unit_parse-0.1.8/src/unit_parse/core.py`

 * *Files identical despite different names*

### Comparing `unit_parse-0.1.7/src/unit_parse/logger.py` & `unit_parse-0.1.8/src/unit_parse/logger.py`

 * *Files identical despite different names*

### Comparing `unit_parse-0.1.7/src/unit_parse/main.py` & `unit_parse-0.1.8/src/unit_parse/main.py`

 * *Files identical despite different names*

### Comparing `unit_parse-0.1.7/src/unit_parse/pre_processing_multiple.py` & `unit_parse-0.1.8/src/unit_parse/pre_processing_multiple.py`

 * *Files identical despite different names*

### Comparing `unit_parse-0.1.7/src/unit_parse/pre_processing_substitution.py` & `unit_parse-0.1.8/src/unit_parse/pre_processing_substitution.py`

 * *Files identical despite different names*

### Comparing `unit_parse-0.1.7/src/unit_parse/reduce_quantities.py` & `unit_parse-0.1.8/src/unit_parse/reduce_quantities.py`

 * *Files identical despite different names*

### Comparing `unit_parse-0.1.7/src/unit_parse/support_files/constants_en.txt` & `unit_parse-0.1.8/src/unit_parse/support_files/constants_en.txt`
...
### Comparing `unit_parse-0.1.7/src/unit_parse/support_files/default_en.txt` & `unit_parse-0.1.8/src/unit_parse/support_files/default_en.txt`
...
### Comparing `unit_parse-0.1.7/src/unit_parse/support_files/dictionary.txt` & `unit_parse-0.1.8/src/unit_parse/support_files/dictionary.txt`

 * *Files identical despite different names*

### Comparing `unit_parse-0.1.7/src/unit_parse/utils.py` & `unit_parse-0.1.8/src/unit_parse/utils.py`

 * *Files identical despite different names*

### Comparing `unit_parse-0.1.7/src/unit_parse.egg-info/PKG-INFO` & `unit_parse-0.1.8/src/unit_parse.egg-info/PKG-INFO`
...
### Comparing `unit_parse-0.1.7/src/unit_parse.egg-info/SOURCES.txt` & `unit_parse-0.1.8/src/unit_parse.egg-info/SOURCES.txt`
...
@@ -18,8 +18,18 @@
 ...
 src/unit_parse/support_files/default_en.txt
