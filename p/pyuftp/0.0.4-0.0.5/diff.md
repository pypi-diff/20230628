# Comparing `tmp/pyuftp-0.0.4.tar.gz` & `tmp/pyuftp-0.0.5.tar.gz`
...
+gzip compressed data, was "pyuftp-0.0.5.tar", last modified: Wed Jun 28 08:00:47 2023, max compression
```

## Comparing `pyuftp-0.0.4.tar` & `pyuftp-0.0.5.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-28 08:00:47.762971 pyuftp-0.0.5/
+-rw-r--r--   0 runner    (1001) docker     (123)     1619 2023-06-28 08:00:36.000000 pyuftp-0.0.5/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (123)     1478 2023-06-28 08:00:47.762971 pyuftp-0.0.5/PKG-INFO
+-rwxr-xr-x   0 runner    (1001) docker     (123)     1145 2023-06-28 08:00:36.000000 pyuftp-0.0.5/README.md
+-rw-r--r--   0 runner    (1001) docker     (123)      369 2023-06-28 08:00:36.000000 pyuftp-0.0.5/pyproject.toml
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-28 08:00:47.762971 pyuftp-0.0.5/pyuftp/
+-rwxr-xr-x   0 runner    (1001) docker     (123)       74 2023-06-28 08:00:36.000000 pyuftp-0.0.5/pyuftp/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)      497 2023-06-28 08:00:47.762971 pyuftp-0.0.5/pyuftp/_version.py
+-rw-r--r--   0 runner    (1001) docker     (123)     7202 2023-06-28 08:00:36.000000 pyuftp-0.0.5/pyuftp/authenticate.py
+-rw-r--r--   0 runner    (1001) docker     (123)     8558 2023-06-28 08:00:36.000000 pyuftp-0.0.5/pyuftp/base.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1831 2023-06-28 08:00:36.000000 pyuftp-0.0.5/pyuftp/client.py
+-rw-r--r--   0 runner    (1001) docker     (123)    11735 2023-06-28 08:00:36.000000 pyuftp-0.0.5/pyuftp/cp.py
+-rw-r--r--   0 runner    (1001) docker     (123)     3382 2023-06-28 08:00:36.000000 pyuftp-0.0.5/pyuftp/share.py
+-rw-r--r--   0 runner    (1001) docker     (123)     7911 2023-06-28 08:00:36.000000 pyuftp-0.0.5/pyuftp/uftp.py
+-rw-r--r--   0 runner    (1001) docker     (123)     6757 2023-06-28 08:00:36.000000 pyuftp-0.0.5/pyuftp/utils.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-28 08:00:47.762971 pyuftp-0.0.5/pyuftp.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)     1478 2023-06-28 08:00:47.000000 pyuftp-0.0.5/pyuftp.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      400 2023-06-28 08:00:47.000000 pyuftp-0.0.5/pyuftp.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-28 08:00:47.000000 pyuftp-0.0.5/pyuftp.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       46 2023-06-28 08:00:47.000000 pyuftp-0.0.5/pyuftp.egg-info/entry_points.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       59 2023-06-28 08:00:47.000000 pyuftp-0.0.5/pyuftp.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        7 2023-06-28 08:00:47.000000 pyuftp-0.0.5/pyuftp.egg-info/top_level.txt
+-rwxr-xr-x   0 runner    (1001) docker     (123)      190 2023-06-28 08:00:47.762971 pyuftp-0.0.5/setup.cfg
+-rwxr-xr-x   0 runner    (1001) docker     (123)     1062 2023-06-28 08:00:36.000000 pyuftp-0.0.5/setup.py
+-rw-r--r--   0 runner    (1001) docker     (123)    83607 2023-06-28 08:00:36.000000 pyuftp-0.0.5/versioneer.py
```

### Comparing `pyuftp-0.0.4/LICENSE` & `pyuftp-0.0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `pyuftp-0.0.4/PKG-INFO` & `pyuftp-0.0.5/README.md`
...
### Comparing `pyuftp-0.0.4/README.md` & `pyuftp-0.0.5/PKG-INFO`
...
### Comparing `pyuftp-0.0.4/pyuftp/authenticate.py` & `pyuftp-0.0.5/pyuftp/authenticate.py`

 * *Files identical despite different names*

### Comparing `pyuftp-0.0.4/pyuftp/client.py` & `pyuftp-0.0.5/pyuftp/client.py`
...
### Comparing `pyuftp-0.0.4/pyuftp/share.py` & `pyuftp-0.0.5/pyuftp/share.py`

 * *Files identical despite different names*

### Comparing `pyuftp-0.0.4/pyuftp/uftp.py` & `pyuftp-0.0.5/pyuftp/uftp.py`
...
### Comparing `pyuftp-0.0.4/pyuftp/utils.py` & `pyuftp-0.0.5/pyuftp/utils.py`
...
### Comparing `pyuftp-0.0.4/pyuftp.egg-info/PKG-INFO` & `pyuftp-0.0.5/pyuftp.egg-info/PKG-INFO`
...
### Comparing `pyuftp-0.0.4/setup.py` & `pyuftp-0.0.5/setup.py`

 * *Files identical despite different names*

### Comparing `pyuftp-0.0.4/versioneer.py` & `pyuftp-0.0.5/versioneer.py`
