# Comparing `tmp/spark_sdk-0.4.22rc7-py3-none-any.whl.zip` & `tmp/spark_sdk-0.4.9-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,17 +1,16 @@
-Zip file size: 27804 bytes, number of entries: 15
--rw-rw-r--  2.0 unx     1266 b- defN 23-Jun-28 10:21 spark_sdk/__init__.py
...
--rw-rw-r--  2.0 unx     3104 b- defN 23-Jun-28 10:21 spark_sdk/pylineage.py
--rw-rw-r--  2.0 unx    51658 b- defN 23-Jun-28 05:01 spark_sdk/pyspark_add_on.py
--rw-rw-r--  2.0 unx     4100 b- defN 23-Mar-12 15:53 spark_sdk/utils.py
--rw-rw-r--  2.0 unx       92 b- defN 22-Oct-10 08:46 spark_sdk-0.4.22rc7.dist-info/.ipynb_checkpoints/requires-checkpoint.txt
--rw-rw-r--  2.0 unx     8487 b- defN 23-Jun-28 10:21 spark_sdk-0.4.22rc7.dist-info/METADATA
--rw-rw-r--  2.0 unx       92 b- defN 23-Jun-28 10:21 spark_sdk-0.4.22rc7.dist-info/WHEEL
--rw-rw-r--  2.0 unx       10 b- defN 23-Jun-28 10:21 spark_sdk-0.4.22rc7.dist-info/top_level.txt
-?rw-rw-r--  2.0 unx     1266 b- defN 23-Jun-28 10:21 spark_sdk-0.4.22rc7.dist-info/RECORD
-15 files, 98144 bytes uncompressed, 25702 bytes compressed:  73.8%
...
-Filename: spark_sdk-0.4.22rc7.dist-info/.ipynb_checkpoints/requires-checkpoint.txt
+Filename: spark_sdk-0.4.9.dist-info/.ipynb_checkpoints/requires-checkpoint.txt
 Comment: 
 
-Filename: spark_sdk-0.4.22rc7.dist-info/METADATA
+Filename: spark_sdk-0.4.9.dist-info/METADATA
 Comment: 
 
-Filename: spark_sdk-0.4.22rc7.dist-info/WHEEL
+Filename: spark_sdk-0.4.9.dist-info/WHEEL
 Comment: 
 
-Filename: spark_sdk-0.4.22rc7.dist-info/top_level.txt
+Filename: spark_sdk-0.4.9.dist-info/top_level.txt
 Comment: 
 
-Filename: spark_sdk-0.4.22rc7.dist-info/RECORD
...
-        conf.set("spark.datahub.rest.server", "http://staging-ccatalog-gms.cads.live")
...
+    def to_dwh_spark(self, data, hdfs_path, repartition=False, numPartitions=None, partition_by='', partition_date='',
         ...
         """
-        # ========================LINEAGE======================
-        from spark_sdk.pylineage import get_job_id, get_flow_id, extract_project_name, emitPythonJob
-        flow_id = extract_project_name(get_flow_id())
-        job_id = get_job_id()
-        try:
-            emitPythonJob(full_table_name = database+'.'+table_name, flow_id = flow_id, job_id = job_id)
...
## Comparing `spark_sdk-0.4.22rc7.dist-info/METADATA` & `spark_sdk-0.4.9.dist-info/METADATA`
...
## Comparing `spark_sdk-0.4.22rc7.dist-info/RECORD` & `spark_sdk-0.4.9.dist-info/RECORD`

 * *Files 26% similar despite different names*

```diff
@@ -1,15 +1,14 @@
-spark_sdk/__init__.py,sha256=O72RWu-hCHG4MkLZ8dIZB5HIxunp6gNRj3uLp-XUtFs,1266
...
-spark_sdk/pylineage.py,sha256=h0RJHmScszZbjGMK52CisDo5wzSMBaJ2n23-eIZPsAA,3104
-spark_sdk/pyspark_add_on.py,sha256=eGxg6T7G2T9Ame4eVHP5eOPxzg6nN_NaYs3HUSVC-4c,51658
-spark_sdk/utils.py,sha256=PmfEZXaqTW9rEcJ8wxrtMRqm3QmPFyL80I9tQ4x7yIU,4100
-spark_sdk-0.4.22rc7.dist-info/.ipynb_checkpoints/requires-checkpoint.txt,sha256=ZGBYK1Crp59m1x-Y3tALQiIew3A2hUYcSce2VIX2Y90,92
-spark_sdk-0.4.22rc7.dist-info/METADATA,sha256=CK4GD5edCHz2oKLnrByrAlOE-z36FoegRSsMm9QN4C0,8487
-spark_sdk-0.4.22rc7.dist-info/WHEEL,sha256=OqRkF0eY5GHssMorFjlbTIq072vpHpF60fIQA6lS9xA,92
-spark_sdk-0.4.22rc7.dist-info/top_level.txt,sha256=hweYK71GSSYJx1YB2cNkxNw2KWVincoyKY8AqJc00Wg,10
-spark_sdk-0.4.22rc7.dist-info/RECORD,,
