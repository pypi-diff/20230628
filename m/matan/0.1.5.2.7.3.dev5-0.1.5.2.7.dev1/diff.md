# Comparing `tmp/matan-0.1.5.2.7.3.dev5.tar.gz` & `tmp/MatAn-0.1.5.2.7.dev1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "matan-0.1.5.2.7.3.dev5.tar", last modified: Wed Jun 28 09:35:28 2023, max compression
+gzip compressed data, was "MatAn-0.1.5.2.7.dev1.tar", last modified: Tue Jun 27 13:59:08 2023, max compression
```

## Comparing `matan-0.1.5.2.7.3.dev5.tar` & `MatAn-0.1.5.2.7.dev1.tar`

### file list

```diff
@@ -1,26 +1,21 @@
-drwxr-xr-x   0 uuu       (1000) uuu       (1000)        0 2023-06-28 09:35:28.473212 matan-0.1.5.2.7.3.dev5/
--rw-r--r--   0 uuu       (1000) uuu       (1000)    34670 2023-06-18 20:22:37.000000 matan-0.1.5.2.7.3.dev5/LICENSE
--rw-r--r--   0 uuu       (1000) uuu       (1000)     4270 2023-06-28 09:35:28.473212 matan-0.1.5.2.7.3.dev5/PKG-INFO
--rw-r--r--   0 uuu       (1000) uuu       (1000)     3337 2023-06-24 20:58:42.000000 matan-0.1.5.2.7.3.dev5/README.md
-drwxr-xr-x   0 uuu       (1000) uuu       (1000)        0 2023-06-28 09:35:28.473212 matan-0.1.5.2.7.3.dev5/matan/
--rw-r--r--   0 uuu       (1000) uuu       (1000)       84 2023-06-19 18:03:25.000000 matan-0.1.5.2.7.3.dev5/matan/__init__.py
--rw-r--r--   0 uuu       (1000) uuu       (1000)      156 2023-06-19 18:03:25.000000 matan-0.1.5.2.7.3.dev5/matan/_misc.py
--rw-r--r--   0 uuu       (1000) uuu       (1000)     4960 2023-06-19 18:03:25.000000 matan-0.1.5.2.7.3.dev5/matan/files.py
-drwxr-xr-x   0 uuu       (1000) uuu       (1000)        0 2023-06-28 09:35:28.473212 matan-0.1.5.2.7.3.dev5/matan/polymers/
--rw-r--r--   0 uuu       (1000) uuu       (1000)        0 2023-06-19 19:18:34.000000 matan-0.1.5.2.7.3.dev5/matan/polymers/__init__.py
-drwxr-xr-x   0 uuu       (1000) uuu       (1000)        0 2023-06-28 09:35:28.473212 matan-0.1.5.2.7.3.dev5/matan/polymers/charpy/
--rw-r--r--   0 uuu       (1000) uuu       (1000)      815 2023-06-19 19:11:47.000000 matan-0.1.5.2.7.3.dev5/matan/polymers/charpy/__init__.py
-drwxr-xr-x   0 uuu       (1000) uuu       (1000)        0 2023-06-28 09:35:28.473212 matan-0.1.5.2.7.3.dev5/matan/polymers/tensile/
-drwxr-xr-x   0 uuu       (1000) uuu       (1000)        0 2023-06-28 09:35:28.473212 matan-0.1.5.2.7.3.dev5/matan/polymers/tensile/ISO527/
--rw-r--r--   0 uuu       (1000) uuu       (1000)     2710 2023-06-24 22:10:32.000000 matan-0.1.5.2.7.3.dev5/matan/polymers/tensile/ISO527/__init__.py
--rw-r--r--   0 uuu       (1000) uuu       (1000)    13789 2023-06-28 09:34:23.000000 matan-0.1.5.2.7.3.dev5/matan/polymers/tensile/__init__.py
--rw-r--r--   0 uuu       (1000) uuu       (1000)       33 2023-06-28 07:43:43.000000 matan-0.1.5.2.7.3.dev5/matan/polymers/tensile/misc.py
--rw-r--r--   0 uuu       (1000) uuu       (1000)     7948 2023-06-27 15:16:07.000000 matan-0.1.5.2.7.3.dev5/matan/sample.py
-drwxr-xr-x   0 uuu       (1000) uuu       (1000)        0 2023-06-28 09:35:28.473212 matan-0.1.5.2.7.3.dev5/matan.egg-info/
--rw-r--r--   0 uuu       (1000) uuu       (1000)     4270 2023-06-28 09:35:28.000000 matan-0.1.5.2.7.3.dev5/matan.egg-info/PKG-INFO
--rw-r--r--   0 uuu       (1000) uuu       (1000)      413 2023-06-28 09:35:28.000000 matan-0.1.5.2.7.3.dev5/matan.egg-info/SOURCES.txt
--rw-r--r--   0 uuu       (1000) uuu       (1000)        1 2023-06-28 09:35:28.000000 matan-0.1.5.2.7.3.dev5/matan.egg-info/dependency_links.txt
--rw-r--r--   0 uuu       (1000) uuu       (1000)       17 2023-06-28 09:35:28.000000 matan-0.1.5.2.7.3.dev5/matan.egg-info/requires.txt
--rw-r--r--   0 uuu       (1000) uuu       (1000)        6 2023-06-28 09:35:28.000000 matan-0.1.5.2.7.3.dev5/matan.egg-info/top_level.txt
--rw-r--r--   0 uuu       (1000) uuu       (1000)      103 2023-06-28 09:35:28.473212 matan-0.1.5.2.7.3.dev5/setup.cfg
--rw-r--r--   0 uuu       (1000) uuu       (1000)     1710 2023-06-28 09:35:25.000000 matan-0.1.5.2.7.3.dev5/setup.py
...
### Comparing `matan-0.1.5.2.7.3.dev5/LICENSE` & `MatAn-0.1.5.2.7.dev1/LICENSE`

 * *Files identical despite different names*

### Comparing `matan-0.1.5.2.7.3.dev5/PKG-INFO` & `MatAn-0.1.5.2.7.dev1/PKG-INFO`
...
+Version: 0.1.5.2.7.dev1
 ...
 License: GPLv3
-Keywords: matbreakpoint()erial analysis,ISO 527,ISO 527-1,polymers analysis,material analysis,tensile test,charpy
...
### Comparing `matan-0.1.5.2.7.3.dev5/README.md` & `MatAn-0.1.5.2.7.dev1/README.md`

 * *Files identical despite different names*

### Comparing `matan-0.1.5.2.7.3.dev5/matan/polymers/charpy/__init__.py` & `MatAn-0.1.5.2.7.dev1/matan/polymers/charpy/__init__.py`

 * *Files identical despite different names*

### Comparing `matan-0.1.5.2.7.3.dev5/matan/polymers/tensile/ISO527/__init__.py` & `MatAn-0.1.5.2.7.dev1/matan/polymers/tensile/ISO527/__init__.py`

 * *Files identical despite different names*

### Comparing `matan-0.1.5.2.7.3.dev5/matan/polymers/tensile/__init__.py` & `MatAn-0.1.5.2.7.dev1/matan/polymers/tensile/__init__.py`
...
### Comparing `matan-0.1.5.2.7.3.dev5/matan.egg-info/PKG-INFO` & `MatAn-0.1.5.2.7.dev1/matan/MatAn.egg-info/PKG-INFO`
...
### Comparing `matan-0.1.5.2.7.3.dev5/setup.py` & `MatAn-0.1.5.2.7.dev1/setup.py`
...
-    keywords=['matbreakpoint()erial analysis',
