# Comparing `tmp/mikro-0.3.80.tar.gz` & `tmp/mikro-0.3.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "mikro-0.3.80.tar", max compression
+gzip compressed data, was "mikro-0.3.9.tar", max compression
```

## Comparing `mikro-0.3.80.tar` & `mikro-0.3.9.tar`

### file list

```diff
@@ -1,29 +1,23 @@
--rw-r--r--   0        0        0      497 2023-05-04 11:33:38.864146 mikro-0.3.80/mikro/__init__.py
--rw-r--r--   0        0        0       38 2022-11-21 13:25:24.312569 mikro-0.3.80/mikro/api/__init__.py
--rw-r--r--   0        0        0   411009 2023-06-12 09:55:46.068438 mikro-0.3.80/mikro/api/schema.py
--rw-r--r--   0        0        0        0 2022-11-21 13:19:21.452118 mikro-0.3.80/mikro/builders.py
--rw-r--r--   0        0        0        0 2023-01-24 14:42:54.553770 mikro-0.3.80/mikro/cli/__init__.py
--rw-r--r--   0        0        0     3237 2023-03-09 16:01:04.382912 mikro-0.3.80/mikro/cli/main.py
--rw-r--r--   0        0        0    92815 2023-01-24 15:15:30.502724 mikro-0.3.80/mikro/cli/schemas/v1.graphql
--rw-r--r--   0        0        0      166 2023-03-09 13:07:49.776971 mikro-0.3.80/mikro/cli/utils.py
--rw-r--r--   0        0        0        0 2022-08-25 14:13:51.564206 mikro-0.3.80/mikro/contrib/__init__.py
--rw-r--r--   0        0        0        0 2022-02-03 16:40:05.361043 mikro-0.3.80/mikro/contrib/fakts/__init__.py
--rw-r--r--   0        0        0     1303 2022-11-21 13:24:56.296558 mikro-0.3.80/mikro/contrib/fakts/datalayer.py
--rw-r--r--   0        0        0     9060 2023-05-31 07:31:29.070469 mikro-0.3.80/mikro/datalayer.py
--rw-r--r--   0        0        0      156 2022-03-21 13:01:57.991994 mikro-0.3.80/mikro/errors.py
--rw-r--r--   0        0        0     1174 2023-04-13 10:19:19.375180 mikro-0.3.80/mikro/funcs.py
--rw-r--r--   0        0        0      830 2023-05-04 11:33:08.291989 mikro-0.3.80/mikro/items.py
--rw-r--r--   0        0        0       92 2022-03-21 13:01:58.083994 mikro-0.3.80/mikro/links/__init__.py
--rw-r--r--   0        0        0     2574 2023-02-27 14:55:12.024266 mikro-0.3.80/mikro/links/datalayer.py
--rw-r--r--   0        0        0        0 2022-05-17 11:20:06.504915 mikro-0.3.80/mikro/links/errors.py
--rw-r--r--   0        0        0     1081 2023-03-04 14:55:46.173689 mikro-0.3.80/mikro/mikro.py
--rw-r--r--   0        0        0     1649 2023-01-19 09:09:28.169699 mikro-0.3.80/mikro/rath.py
--rw-r--r--   0        0        0    14412 2023-06-12 10:09:46.191178 mikro-0.3.80/mikro/scalars.py
--rw-r--r--   0        0        0     7369 2023-05-26 10:44:02.516776 mikro-0.3.80/mikro/structures.py
--rw-r--r--   0        0        0        0 2023-03-04 15:06:28.973785 mikro-0.3.80/mikro/testing/__init__.py
--rw-r--r--   0        0        0     1225 2023-03-04 15:22:43.161911 mikro-0.3.80/mikro/testing/datalayer.py
--rw-r--r--   0        0        0    12346 2023-06-07 08:20:53.944356 mikro-0.3.80/mikro/traits.py
--rw-r--r--   0        0        0     1314 2023-05-19 13:15:39.685195 mikro-0.3.80/mikro/utils.py
--rw-r--r--   0        0        0     1462 2023-06-27 13:36:16.567325 mikro-0.3.80/mikro/widgets.py
--rw-r--r--   0        0        0     1760 2023-06-28 09:42:12.304314 mikro-0.3.80/pyproject.toml
--rw-r--r--   0        0        0      882 1970-01-01 00:00:00.000000 mikro-0.3.80/PKG-INFO
...
### Comparing `mikro-0.3.80/mikro/contrib/fakts/datalayer.py` & `mikro-0.3.9/mikro/contrib/fakts/datalayer.py`

 * *Files identical despite different names*

### Comparing `mikro-0.3.80/mikro/funcs.py` & `mikro-0.3.9/mikro/funcs.py`

 * *Files identical despite different names*

### Comparing `mikro-0.3.80/mikro/links/datalayer.py` & `mikro-0.3.9/mikro/links/datalayer.py`
...
### Comparing `mikro-0.3.80/mikro/rath.py` & `mikro-0.3.9/mikro/rath.py`
...
### Comparing `mikro-0.3.80/mikro/scalars.py` & `mikro-0.3.9/mikro/scalars.py`
...
### Comparing `mikro-0.3.80/pyproject.toml` & `mikro-0.3.9/pyproject.toml`
...
### Comparing `mikro-0.3.80/PKG-INFO` & `mikro-0.3.9/PKG-INFO`
